...
exports.demonstrateSafeParsing = demonstrateSafeParsing;
...
const ageSchema = zod_1.z.number()
    .int("Age must be a whole number")
    .positive("Age must be positive")
    .max(120, "Age seems unrealistic");
// Boolean validation
const isActiveSchema = zod_1.z.boolean();
// Email validation using built-in email validator
const emailSchema = zod_1.z.string().email("Please provide a valid email address");
// URL validation
const websiteSchema = zod_1.z.string().url("Please provide a valid URL");
// Date string validation
const dateSchema = zod_1.z.string().datetime("Please provide a valid ISO datetime");
// ========================================
// EXAMPLE USAGE
// ========================================
...
// ========================================
function demonstrateSafeParsing() {
...
//# sourceMappingURL=basic-validation.js.map