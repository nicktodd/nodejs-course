// this function takes in an array of any type and returns the smallest element
...
// the generic type inferred as number here
const r2 = min([3, 12, 19, 1, 2, 7]);

// the generic type inferred as string here
